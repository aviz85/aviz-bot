...
class ChatBot:
    ...
    def get_chat_response(self, user_message):
        try:
            ...
            # Check if the response is in Hebrew using regex
            if self.is_hebrew(chat_response):
                # Refine the response using the external RefineText class
                refine_text = RefineText()
                refined_response = refine_text.refine_message(chat_response)
    ...
    def is_hebrew(self, text):
        # Regex pattern to match Hebrew characters
