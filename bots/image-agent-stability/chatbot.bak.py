...
from generate_image import generate_image  # שימו לב לשם הקובץ הנכון
...
# Setup logging
logging.basicConfig(filename='chatbot.log', level=logging.DEBUG, format='%(asctime)s %(levelname)s %(name)s %(message)s')
            ...
            if tool_calls is not None:
                for tool_call in tool_calls:
                    ...
                    if tool_name == "generate_image":
                        ...
                        print(f"Image generated at path: {image_path}")
                        ...
                        return {"text": chat_response, "image_url": image_url}
